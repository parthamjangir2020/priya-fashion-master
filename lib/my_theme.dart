...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(240, 2, 186, 1.0);
  static const Color accent_color_shadow =
      Color.fromRGBO(255, 79, 219, 1.0); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(250, 161, 229, 1.0);
  static Color splash_screen_color = Color.fromRGBO(
      250, 161, 229, 1.0); // if not sure , use the same color as accent color
